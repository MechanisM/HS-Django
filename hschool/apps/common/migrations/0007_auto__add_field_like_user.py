...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('common_like', 'user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='liked_hentais', null=True, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Like.user'
        db.delete_column('common_like', 'user_id')
    ...
    models = {
        ...
        'common.like': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'liked_hentais'", 'null': 'True', 'to': "orm['auth.User']"})
        },
        'common.seriestag': {
