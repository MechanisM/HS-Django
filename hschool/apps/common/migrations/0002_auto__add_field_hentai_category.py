...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Hentai.category'
        db.add_column('common_hentai', 'category', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='hentais', null=True, to=orm['common.Category']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Hentai.category'
        db.delete_column('common_hentai', 'category_id')
