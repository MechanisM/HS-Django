...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Hentai.download_url'
        db.alter_column('common_hentai', 'download_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Hentai.download_url'
        db.alter_column('common_hentai', 'download_url', self.gf('django.db.models.fields.URLField')(default=None, max_length=200))
