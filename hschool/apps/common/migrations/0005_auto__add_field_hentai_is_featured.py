...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Hentai.is_featured'
        db.add_column('common_hentai', 'is_featured', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Hentai.is_featured'
        db.delete_column('common_hentai', 'is_featured')
