...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Hentai.thumbnail'
        db.add_column('common_hentai', 'thumbnail', self.gf('django.db.models.fields.files.ImageField')(max_length=256, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Hentai.thumbnail'
        db.delete_column('common_hentai', 'thumbnail')
